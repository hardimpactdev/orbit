...
Route::middleware(CorrelationHeader::class)->group(function (): void {
    ...
    Route::middleware([
        ...
        Route::get('/apps/{app}/setup-steps', [AppSetupStepController::class, 'index']);
        Route::post('/apps/{app}/setup-steps', [AppSetupStepController::class, 'store']);
        Route::delete('/apps/{app}/setup-steps/{step}', [AppSetupStepController::class, 'destroy']);
