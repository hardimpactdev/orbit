...
const totalSteps = ref(props.server.provisioning_total_steps ?? 14);
...
const checklistItems = [
    ...
    { step: 10, label: 'PHP 8.3 & 8.4 via php.new' },
    { step: 14, label: 'Launchpad stack (Caddy, PostgreSQL, Redis, Mailpit)' },
];
...
async function pollStatus() {
    try {
        ...
        totalSteps.value = data.provisioning_total_steps ?? 14;
