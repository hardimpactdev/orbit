...
describe('node permission registry', function (): void {
    ...
    it('checks whether permission sets allow a required permission', function (): void {
        ...
        expect($registry->allows(['tool:read'], 'tool:show'))
            ...
            ->toBeFalse()
            ->and($registry->allows(['app:read'], 'app:credentials'))
            ->toBeFalse()
            ->and($registry->allows(['app:read'], 'app-setup-step:list'))
            ->toBeTrue()
            ->and($registry->allows(['app:write'], 'app:credentials'))
            ->toBeFalse()
            ->and($registry->allows(['app:write'], 'app:setup'))
            ->toBeTrue()
            ->and($registry->allows(['app:write'], 'app-setup-step:add'))
            ->toBeTrue()
            ->and($registry->allows(['app:write'], 'app-setup-step:list'))
            ->toBeFalse()
            ->and($registry->allows(['app:credentials'], 'app:credentials'))
            ->toBeTrue()
            ->and($registry->allows(['app:*'], 'app:credentials'))
            ->toBeTrue()
    ...
    it('returns empty implied list for permissions without implications', function (): void {
        expect(new NodePermissionRegistry()->impliedBy('tool:credentials'))
            ->toBe([])
            ->and(new NodePermissionRegistry()->impliedBy('app:credentials'))
            ->toBe([])
