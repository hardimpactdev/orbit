...
final class AppDoctorIssueDefinitions implements DoctorIssueDefinitionProvider
{
    ...
    public function definitions(): array
    {
        return [
            ...
            self::genuine('app.production_user_mismatch', 'app', 'restore_app_production_user_mismatch'),
            self::genuine('app.production_user_missing', 'app', 'restore_app_production_user_missing'),
            self::genuine('app.runtime_config_extra', 'app', 'restore_app_runtime_config_extra'),
            self::genuine('app.runtime_config_mismatch', 'app', 'restore_app_runtime_config_mismatch'),
            self::genuine('app.runtime_config_missing', 'app', 'restore_app_runtime_config_missing'),
            self::genuine('app.security.fs_permissions', 'app', 'restore_app_security_fs_permissions'),
            self::genuine('app.security.system_user', 'app', 'restore_app_security_system_user'),
