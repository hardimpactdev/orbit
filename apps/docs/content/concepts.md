...
- **RemoteShell** — provisioning/bootstrap SSH used before a node can accept Agent-push envelopes. Break-glass SSH is operator-owned super-admin recovery outside normal Orbit command execution. See [Runtime Execution Lanes](execution-lanes.md).
