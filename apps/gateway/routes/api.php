...
use App\Http\Controllers\Api\AppExecController;
...
use App\Http\Controllers\Api\WorkspaceExecController;
...
Route::middleware(CorrelationHeader::class)->group(function (): void {
    ...
    Route::middleware([WireGuardIdentity::class, RequireGrantPermission::class, LogActivity::class])->group(function (): void {
        ...
        Route::post('/database-connections/{connection}/targets', [DatabaseConnectionController::class, 'attach']);
        Route::delete('/database-connections/{connection}/targets', [DatabaseConnectionController::class, 'detach']);
        ...
        Route::post('/workspaces/exec/by-path', [WorkspaceExecController::class, 'byPath']);
        Route::get('/workspaces/{name}/history', WorkspaceHistoryController::class);
        Route::post('/workspaces/{name}/exec', WorkspaceExecController::class);
