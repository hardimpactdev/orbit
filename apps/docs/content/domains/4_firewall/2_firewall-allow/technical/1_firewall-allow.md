# Technical Contract: `orbit firewall:allow [name] --port=<port> [--node=<node>] [--node-transport=<transport>] [--direction=<incoming|outgoing>] [--from=<cidr>] [--to=<cidr>] [--protocol=<tcp|udp>] [--reason=<text>] [--json]`
...
```bash
orbit firewall:allow [name] --port=<port> [--node=<node>] [--node-transport=<transport>] [--direction=<incoming|outgoing>] [--from=<cidr>] [--to=<cidr>] [--protocol=<tcp|udp>] [--reason=<text>] [--json]
```
