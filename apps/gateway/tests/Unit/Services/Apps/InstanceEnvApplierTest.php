 ...
 */
describe('InstanceEnvApplier', function (): void {
    it('updates the app env file on the owning node', function (): void {
        ...
        $result = app(InstanceEnvApplier::class)->apply($app, $instance, [
            'MAIL_MAILER' => 'smtp',
        ]);
    ...
    it('clears Laravel caches and reapplies the runtime container for PHP apps', function (): void {
        ...
        $shell = new InstanceEnvApplierRecordingRemoteShell(
...
final class InstanceEnvApplierRecordingRemoteShell implements RemoteShell
{
    /**
     * @var list<string>
     */
