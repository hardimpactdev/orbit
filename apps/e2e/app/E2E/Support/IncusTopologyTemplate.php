...
final readonly class IncusTopologyTemplate
{
     ...
     */
    public static function clone(IncusHost $host, E2ETopologyKind $kind, string $runId, ?E2EPhaseTimer $timer = null, bool $stateful = false, bool $sourceMounted = false, ?string $networkName = null, ?string $subnetPrefix = null): array
    {
        $timer ??= new E2EPhaseTimer;
        $roles = self::rolesFor($kind);

        $script = self::buildBatchScript($host, $kind, $runId, $roles, stateful: $stateful, sourceMounted: $sourceMounted, networkName: $networkName, subnetPrefix: $subnetPrefix);
     ...
     */
    public static function buildBatchScript(IncusHost $host, E2ETopologyKind $kind, string $runId, array $roles, ?bool $stateful = null, bool $sourceMounted = false, ?string $networkName = null, ?string $subnetPrefix = null): string
    {
