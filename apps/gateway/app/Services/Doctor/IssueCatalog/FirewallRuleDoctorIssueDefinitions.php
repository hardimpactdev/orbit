...
final class FirewallRuleDoctorIssueDefinitions implements DoctorIssueDefinitionProvider
{
    ...
    public function definitions(): array
    {
        return [
            ...
            self::genuine('firewall_rule.rule_mismatch', 'firewall_rule', 'restore_firewall_rule_rule_mismatch'),
            self::genuine('firewall_rule.rule_missing', 'firewall_rule', 'restore_firewall_rule_rule_missing'),
        ];
    }
}
