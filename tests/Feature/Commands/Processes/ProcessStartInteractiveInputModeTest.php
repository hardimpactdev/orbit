...
function createProcessStartInteractiveLocalNode(string $role = 'gateway'): Node
{
...
it('prompts for app when app is absent', function (): void {
    createProcessStartInteractiveLocalNode('gateway');
...
it('does not prompt when --app is supplied', function (): void {
    ...
    $this->artisan('process:start --app=docs')
