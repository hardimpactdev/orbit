...
- Required verification:
  ...
  - `composer quality-check`: passed for changed-surface lanes; blocked only by unrelated pre-existing `apps/cli` Rector dry-run change, recorded in `.orbit/quality-gates/quality-check-interpretation-2026-07-02T043551Z.json`.
