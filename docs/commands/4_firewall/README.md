...
- Bootstrap policy includes Orbit/WireGuard management access and public ingress decisions specific to each node role. Firewall commands do not create public SSH policy exceptions for app nodes.
