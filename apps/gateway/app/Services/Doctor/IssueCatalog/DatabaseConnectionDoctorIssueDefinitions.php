...
final class DatabaseConnectionDoctorIssueDefinitions implements DoctorIssueDefinitionProvider
{
    ...
    public function definitions(): array
    {
        return [
            ...
            self::genuine('database_connection.env_mismatch', 'database_connection', 'restore_database_connection_env_mismatch'),
            self::genuine('database_connection.env_missing', 'database_connection', 'restore_database_connection_env_missing'),
            ...
            self::genuine('database_connection.target_missing', 'database_connection', 'restore_database_connection_target_missing'),
