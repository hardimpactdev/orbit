# Technical Contract: `orbit schedule:add [name] [--app=<app>] [--node=<node>] [--node-transport=<transport>] [--command=<command>] [--script=<path>] [--interval=<expression>] [--timezone=<timezone>] [--json]`
...
```bash
orbit schedule:add [name] [--app=<app>] [--node=<node>] [--node-transport=<transport>] [--command=<command>] [--script=<path>] [--interval=<expression>] [--timezone=<timezone>] [--json]
```
