...
5. **`harness-signals/`**: curated signal records to search for prior
   occurrences, guardrail changes, and recurrence checks
6. **`.agents/skills/`**: domain procedures activated just-in-time per change
   type
7. **`PRODUCT_DECISIONS.md`**: dated product intent ledger for direction
   changes and reversals
8. **`apps/docs/content/`**: product authority (behavior contracts, not
   repo-dev procedures)
9. **`bin/orbit-prepare-worktree`**: create and bootstrap isolated
   implementation worktrees
10. **Root Composer scripts**: orchestrate docs-lint, tests, Pint, PHPStan,
