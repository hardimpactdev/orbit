...
| Path | Coverage |
| --- | --- |
| `apps/cli/tests/Feature/Commands/Firewall/FirewallWriteCommandTest.php` | CLI firewall:allow validation, POST forwarding, JSON success envelope, progress tree output, and backend apply failure recovery prose. |
| `apps/cli/tests/Feature/Commands/Firewall/FirewallInteractiveInputModeTest.php` | Interactive allow prompts, prompt validation, and side-effect prevention before input resolution. |
...
- [`5.1_firewall-allow_input-mode_interactive.md`](5.1_firewall-allow_input-mode_interactive.md#test-mapping)
- [`5.2_firewall-allow_input-mode_non-interactive.md`](5.2_firewall-allow_input-mode_non-interactive.md#test-mapping)

Renderer-specific test mapping lives in:

- [`6.1_firewall-allow_output-render_human.md`](6.1_firewall-allow_output-render_human.md#test-mapping)
- [`6.2_firewall-allow_output-render_json.md`](6.2_firewall-allow_output-render_json.md#test-mapping)
