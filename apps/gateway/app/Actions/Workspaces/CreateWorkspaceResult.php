...
{
    /**
     * @param  array{result: array{action: 'created'}, workspace: array<string, mixed>, meta: array<string, mixed>}|null  $data
    ...
    /**
     * @param  array{result: array{action: 'created'}, workspace: array<string, mixed>, meta: array<string, mixed>}  $data
     * @param  list<string>  $completedSteps
     */
    ...
    {
        if ($this->data === null) {
            throw new \LogicException('A failed workspace creation result has no success data.');
        }
