...
4. **No lifecycle environment capture.** The lifecycle environment variables
   defined in
   [`5_workspace/README.md`](../../README.md#lifecycle-step-environment)
...
- Connect to running processes, tail journald, or otherwise stream live
  ...
  [`orbit process:logs`](../../../6_process/8_process-logs/process-logs.md).
...
- Captured output is removed atomically with the workspace via
  ...
  [`app:remove`](../../../4_app/6_app-remove/app-remove.md) or
  the [`app:prune`](../../../4_app/7_app-prune/app-prune.md) cascade when an
