...
final readonly class ProcessListController implements Loggable
{
    ...
    #[OpenApiResponse(
        ...
        type: 'array{success: array{data: array{context: array{node: string, project: string|null, instance: string|null, workspace: string|null}, processes: list<array{node: string, project: string|null, instance: string|null, workspace: string|null, name: string, command: string|null, restart_policy: string, crash_notification: string, runtime: string, tool: string|null, service: array<string, mixed>|null, runtime_unit: string, status: \'running\'|\'stopped\'|\'crashed\'|\'unknown\', last_event: array{id: int, type: string}|null}>}, meta: object}}',
    )]
