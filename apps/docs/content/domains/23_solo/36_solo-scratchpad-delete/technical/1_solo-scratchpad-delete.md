...
- [Interactive input mode](5.1_solo-scratchpad-delete_input-mode_interactive.md)
- [Non-interactive input mode](5.2_solo-scratchpad-delete_input-mode_non-interactive.md)
