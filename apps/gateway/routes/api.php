...
use App\Http\Controllers\Api\InstanceApplicationLogController;
use App\Http\Controllers\Api\InstanceApplicationLogStreamStartController;
...
use App\Http\Controllers\Api\WorkspaceApplicationLogController;
use App\Http\Controllers\Api\WorkspaceApplicationLogStreamStartController;
...
Route::middleware(CorrelationHeader::class)->group(function (): void {
    ...
    Route::middleware([
        ...
        Route::get('/workspaces/{workspace}/log', WorkspaceApplicationLogController::class);
        Route::post('/workspaces/{workspace}/log-stream', WorkspaceApplicationLogStreamStartController::class);
        ...
        Route::get('/instances/{instance}/log', InstanceApplicationLogController::class);
        Route::post('/instances/{instance}/log-stream', InstanceApplicationLogStreamStartController::class);
