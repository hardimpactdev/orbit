...
it('stages local Docker image archives in the pushed provisioning bundle when available on the Incus host', function (): void {
    ...
    expect($remoteBundle)
        ...
        ->and($commandOutput)
        ->toContain("docker pull 'ghcr.io/hardimpactdev/orbit-frankenphp:2-php8.5-bookworm'")
        ->and($commandOutput)
        ->toContain("docker save 'ghcr.io/hardimpactdev/orbit-frankenphp:2-php8.5-bookworm'")
        ->and($commandOutput)
        ...
        ->and($commandOutput)
        ->toContain("docker image inspect 'valkey/valkey:8.1'")
        ->and($commandOutput)
        ->toContain("docker pull 'valkey/valkey:8.1'")
        ->and($commandOutput)
        ->toContain("docker save 'valkey/valkey:8.1'")
        ->and($commandOutput)
        ->toContain("'{$remoteStage}/orbit-e2e-bundle/valkey-8.1.tar'")
        ->and($commandOutput)
