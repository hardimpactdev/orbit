...
Codex App project registration. Orbit app and instance records remain owned by the instance family, and
Codex App configuration is applied on the selected operator node through the
gateway.

[`doctor --family=instance`](../5_app/instance-doctor.md) owns app registry and instance
