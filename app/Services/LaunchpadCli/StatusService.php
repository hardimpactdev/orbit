...
/**
 * Service for status and health-related launchpad operations.
 */
class StatusService
{
    ...
    /**
     * Get launchpad status for an environment.
     */
    ...
    /**
     * Get launchpad status with configurable timeout.
     */
    ...
    /**
     * Check if launchpad CLI is installed on the environment.
     */
