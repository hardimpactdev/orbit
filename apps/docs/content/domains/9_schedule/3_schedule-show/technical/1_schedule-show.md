# Technical Contract: `orbit schedule:show [name] [--app=<app>] [--node=<node>] [--node-transport=<transport>] [--json]`
...
```bash
orbit schedule:show [name] [--app=<app>] [--node=<node>] [--node-transport=<transport>] [--json]
```
