...
- Verification:
  ...
  - runtime: passed - retained Incus topology dev-d4e4eb installed the candidate archive, reached active with Redis, used image sha256:7f26c9a4320aeb83d4a997d6d2341713e0c4ef9fe82ae133a32c1b553c9d797a without source binds, and returned HTTPS 404; evidence `.orbit/evidence/runtime-proof.txt`; live services1 reached active against database1 Redis and remained reachable at HTTPS 10.6.0.14:8080; evidence `.orbit/evidence/live-services1-proof.txt`
