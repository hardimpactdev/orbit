...
intent, Prometheus and Grafana Docker Swarm process definitions, a node-exporter
systemd process definition, the router-owned `metrics.orbit` route, and Grafana
admin credentials.
