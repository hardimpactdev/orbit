...
it('reads workspace history from a non-gateway caller through the gateway api', function (): void {
    ...
    try {
        ...
        $result = $topology->ssh(
            'operator',
            sprintf(
                'cd %s && orbit workspace:history feature-docs --instance=docs --json',
