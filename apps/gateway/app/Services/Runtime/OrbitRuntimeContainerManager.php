...
class OrbitRuntimeContainerManager
{
    public function __construct(
        private readonly DockerCommandBuilder $commands,
    ) {}

    public function apply(OrbitRuntimeContainer $container): void
    {
    ...
    public function converge(OrbitRuntimeContainer $container): void
    {
        $this->apply($container);
    }

    private function ensureNetwork(OrbitRuntimeContainer $container): void
    {
     ...
     */
    private function inspect(OrbitRuntimeContainer $container): ?array
    {
     ...
     */
    private function matchesSpec(array $inspection, OrbitRuntimeContainer $container): bool
    {
        ...
        return ($labels[OrbitRuntimeContainer::SpecHashLabel] ?? null) === $container->specHash();
    }
