# Technical Contract: `orbit workspace:run:log <run>`

[Back to public `workspace:run:log` documentation.](../workspace-run-log.md)
...
`steps[].status` is an execution enum, defined per step, that is owned by `workspace:run:log`.
...
- [`6.1_workspace-run-log_output-render_human.md`](6.1_workspace-run-log_output-render_human.md):
  progress tree of captured steps, per-step stdout/stderr formatting,
  truncation marker rendering, prose errors.
- [`6.2_workspace-run-log_output-render_json.md`](6.2_workspace-run-log_output-render_json.md):
...
`workspace:run:log` exits zero whenever the gateway read succeeds, including
...
- `workspace:run:log` explains **past behavior**: which step in a captured run
...
- [`doctor --family=workspace`](../../workspace-doctor.md) verifies
  **current reality** and owns repair behavior. `doctor` does not rewrite
  or repair captured `workspace:run:log` history; it converges live workspace
...
- [`6.1_workspace-run-log_output-render_human.md`](6.1_workspace-run-log_output-render_human.md#test-mapping)
- [`6.2_workspace-run-log_output-render_json.md`](6.2_workspace-run-log_output-render_json.md#test-mapping)
