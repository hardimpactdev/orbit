...
class IncusTopologyBuilder
{
    ...
    private const GatewayWireGuardIp = '10.6.0.2';

    private const ControlWireGuardIp = '10.6.0.3';

    private const DevWireGuardIp = '10.6.0.4';

    private const ProdWireGuardIp = '10.6.0.5';
