...
`tool-reload` performs command-owned reload enactment while preserving gateway tool intent. [`tool-doctor.md`](../../tool-doctor.md) owns the authoritative tool-family probe, issue codes, fix map, and adopt map.
