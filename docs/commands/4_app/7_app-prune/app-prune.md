...
[`workspace:remove`](../../5_workspace/5_workspace-remove/workspace-remove.md):
...
- [`orbit workspace:remove`](../../5_workspace/5_workspace-remove/workspace-remove.md) — Manually remove a specific workspace.
