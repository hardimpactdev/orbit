...
`proxy:add` does not edit routes owned by apps, instances, WebSocket bindings,
...
- The selected domain is not owned by an app, instance, WebSocket binding, workspace,
