...
```bash
orbit instance:websocket enable <project.instance> [--host=<hostname>] [--json]
```
...
5. Syncs the Reverb runtime project configuration so the running Reverb node
...
and inspect project configuration.
...
- [`project:show`](../4_project-show/project-show.md) — inspect the full project entity
