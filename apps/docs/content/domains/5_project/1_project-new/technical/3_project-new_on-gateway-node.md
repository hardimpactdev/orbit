# `project:new` From A Gateway Node

[Back to technical contract](1_project-new.md)

This page describes the gateway-side authorization decision when `orbit project:new`
...
- **Apply:** The gateway atomically writes the project and named first
