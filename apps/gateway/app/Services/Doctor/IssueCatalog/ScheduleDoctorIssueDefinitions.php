...
final class ScheduleDoctorIssueDefinitions implements DoctorIssueDefinitionProvider
{
    ...
    public function definitions(): array
    {
        return [
            ...
            self::genuine('schedule.runtime_hibernator_image_mismatch', 'schedule', 'restore_schedule_runtime_hibernator_image_mismatch'),
            self::genuine('schedule.runtime_hibernator_missing', 'schedule', 'restore_schedule_runtime_hibernator_missing'),
            self::genuine('schedule.runtime_hibernator_replicas_mismatch', 'schedule', 'restore_schedule_runtime_hibernator_replicas_mismatch'),
            self::genuine('schedule.runtime_hibernator_stopped', 'schedule', 'restore_schedule_runtime_hibernator_stopped'),
            ...
            self::genuine('schedule.scheduler_replicas_mismatch', 'schedule', 'restore_schedule_scheduler_replicas_mismatch'),
