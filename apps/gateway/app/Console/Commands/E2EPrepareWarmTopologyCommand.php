...
#[Signature('e2e:prepare-warm-topology
    {kind=operator_gateway_app-dev_app-prod_agent : Topology kind to warm (operator|operator_gateway|operator_gateway_app-dev|operator_gateway_app-dev_app-prod|operator_gateway_agent|operator_gateway_app-dev_app-prod_agent|operator_gateway_app-prod_ingress)}
