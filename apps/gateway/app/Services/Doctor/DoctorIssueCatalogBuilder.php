...
/**
 * Builds the family-owned Doctor issue catalog once.
 */
final class DoctorIssueCatalogBuilder
{
    /**
    ...
    public static function build(): array
    {
        ...
        foreach (self::providers() as $provider) {
            foreach ($provider->definitions() as $definition) {
                self::assertUnique($definitions, $definition);
                self::assertGenuineIsDispatchable($definition);
     ...
     */
    private static function assertUnique(array $definitions, DoctorIssueDefinition $definition): void
    {
    ...
    private static function assertGenuineIsDispatchable(DoctorIssueDefinition $definition): void
    {
