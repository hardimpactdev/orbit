...
Add one concrete instance to an existing project.
...
creates one instance row without changing the project or sibling instances.
...
- [`project:new`](../1_project-new/project-new.md)
