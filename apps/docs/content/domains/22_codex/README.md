...
Codex App project registration. Project and instance records remain owned by the instance family, and
Codex App configuration is applied on the selected operator node through the
gateway.

[`doctor --family=instance`](../5_app/instance-doctor.md) owns project registry and instance
...
1. [`orbit codex:app add|remove|list [project]`](1_codex-app/codex-app.md)

## Related

- [`orbit extension:enable codex`](../21_extension/2_extension-enable/extension-enable.md)
- [`orbit project:*` and `orbit instance:*`](../5_app/README.md)
