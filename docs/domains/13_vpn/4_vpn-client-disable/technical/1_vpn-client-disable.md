...
| Path | Coverage |
| --- | --- |
| `tests/Feature/Commands/Vpn/VpnClientDisableCommandTest.php` | Command contract: grant denial, non-gateway SSH, runtime execution, TOTP, disablement, idempotent success, missing-client failure, node-peer protection, and no node writes. |
