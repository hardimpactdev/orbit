...
final readonly class InstanceEnvApplier
{
    /**
     ...
     */
    public function apply(App $app, Instance $instance, array $values): InstanceEnvApplyResult
    {
        ...
        return new InstanceEnvApplyResult($envPath, $cacheCleared, $runtimeOutcome);
    }

    public function envPath(Instance $instance): ?string
    {
