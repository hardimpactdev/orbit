...
| `apps/cli/tests/Feature/InternalFirewallRuleCommandTest.php` | UFW prepend placement for allow rules, unchanged deny placement, and stable backend comment identity. |
