...
Serving assertions are feature behavior, not provision-gate behavior. `project:new`,
...
`ghcr.io/hardimpactdev/orbit-frankenphp:1-php8.5-bookworm` Docker image archives when those images
