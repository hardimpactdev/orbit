...
return [
     ...
     */
    'export_path' => env('ORBIT_OPENAPI_EXPORT_PATH', base_path('../../.orbit/evidence/gateway-openapi.json')),
    ...
    'info' => [
         ...
         * API version.
         */
        'version' => env('API_VERSION', env('ORBIT_VERSION', '0.0.0')),

        /*
         * Description rendered on the home page of the API documentation (`/docs/api`).
         */
        'description' => 'HTTP contract exposed by an Orbit gateway for local nodes, agents, apps, workspaces, processes, and control-plane operations.',
    ],
