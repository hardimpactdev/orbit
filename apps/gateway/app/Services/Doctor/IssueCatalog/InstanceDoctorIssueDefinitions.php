...
final class InstanceDoctorIssueDefinitions implements DoctorIssueDefinitionProvider
{
    ...
    public function definitions(): array
    {
        return [
            ...
            self::genuine('instance.production_user_mismatch', 'instance', 'restore_app_production_user_mismatch'),
            self::genuine('instance.production_user_missing', 'instance', 'restore_app_production_user_missing'),
            ...
            self::genuine('instance.runtime_config_extra', 'instance', 'restore_app_runtime_config_extra'),
            self::genuine('instance.runtime_config_mismatch', 'instance', 'restore_app_runtime_config_mismatch'),
            self::genuine('instance.runtime_config_missing', 'instance', 'restore_app_runtime_config_missing'),
            ...
            self::genuine('instance.security.fs_permissions', 'instance', 'restore_app_security_fs_permissions'),
            self::incident('instance.security.runtime_container_isolation', 'instance'),
            self::genuine('instance.security.system_user', 'instance', 'restore_app_security_system_user'),
