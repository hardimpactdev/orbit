...
final readonly class DoctorInstanceTargetResolver
{
    ...
    public function resolve(?string $selector, Node $caller, string $permission): ?DoctorInstanceTarget
    {
        if ($selector === null) {
            return null;
        }
        ...
        $instanceIsVisible = fn (Instance $instance): bool => $this->selectorResolver
        ...
        $wasExplicitInstance = $selection->instance instanceof Instance;
        ...
        return new DoctorInstanceTarget($selection->app, $instance, $node);
    }
