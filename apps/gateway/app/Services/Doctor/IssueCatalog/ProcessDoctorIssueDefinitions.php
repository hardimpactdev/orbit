...
final class ProcessDoctorIssueDefinitions implements DoctorIssueDefinitionProvider
{
    ...
    {
        return [
            self::genuine('process.event_notifier_mismatch', 'process', 'restore_process_event_notifier_mismatch'),
            self::genuine('process.event_notifier_missing', 'process', 'restore_process_event_notifier_missing'),
            ...
            self::genuine('process.runtime_unit_missing', 'process', 'restore_process_runtime_unit_missing'),
            self::genuine('process.runtime_unit_unloaded', 'process', 'restore_process_runtime_unit_unloaded'),
            self::genuine('process.runtime_unit_unrenderable', 'process', 'restore_process_runtime_unit_unrenderable'),
