 ...
 * provisioning plan (`docs/superpowers/plans/2026-05-16-gateway-dns-provisioning.md`).
 */
it('serves a freshly provisioned development app from the control over its TLD hostname', function (): void {
    ...
    $run = E2ERun::start($provider, 'app-new-reachable');
    $bundle = null;
    $passed = false;
    ...
    try {
        ...
        E2ECommand::ssh(
            ...
            sprintf(
                ...
                escapeshellarg("<?php echo 'orbit-e2e-app-new-reachable';"),
            ),
            timeoutSeconds: 60,
        );
        ...
        E2EReachability::assertHttpResponseContains(
            ...
            key: $key,
            url: "https://{$name}.test/",
            marker: 'orbit-e2e-app-new-reachable',
        );
