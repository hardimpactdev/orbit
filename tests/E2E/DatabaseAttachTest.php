...
it('attaches a database connection to an app from the control node through the gateway api', function (): void {
...
PHP;
        ...
        $result = $topology->ssh(
            'control',
            sprintf(
                'cd %s && php artisan database:attach %s --app=%s --env-prefix=DB --json',
