    ...
    public function definitions(): array
    {
        return [
            ...
            self::genuine(
                ...
                'proxy',
                'restore_proxy_agent_tool_route_mismatch',
            ),
            self::invalid('proxy.backend_node_invalid', 'proxy'),
            self::genuine(
                'proxy.agent_tool_route_missing',
                'proxy',
                'restore_proxy_agent_tool_route_missing',
            ),
            self::genuine(
            ...
            self::genuine(
                ...
                'proxy',
                'restore_proxy_backend_route_mismatch',
            ),
            self::genuine(
                'proxy.backend_route_missing',
                'proxy',
                'restore_proxy_backend_route_missing',
            ),
            self::genuine(
                'proxy.caddy_container_detached',
                'proxy',
                'restore_proxy_caddy_container_detached',
            ),
            self::genuine(
                'proxy.caddy_container_down',
                'proxy',
                'restore_proxy_caddy_container_down',
            ),
            self::genuine(
                'proxy.caddy_container_missing',
                'proxy',
                'restore_proxy_caddy_container_missing',
            ),
            self::genuine(
                'proxy.dns_mapping_mismatch',
                'proxy',
                'restore_proxy_dns_mapping_mismatch',
            ),
            ...
            self::genuine(
                ...
                'proxy',
                'restore_proxy_enactment_incomplete',
            ),
            self::genuine(
                'proxy.global_config_mismatch',
                'proxy',
                'restore_proxy_global_config_mismatch',
            ),
            self::genuine(
                'proxy.global_config_missing',
                'proxy',
                'restore_proxy_global_config_missing',
            ),
            ...
            self::genuine(
                ...
                'proxy',
                'restore_proxy_public_route_mismatch',
            ),
            self::genuine(
            ...
            self::genuine(
                'proxy.route_missing',
                'proxy',
                'restore_proxy_route_missing',
            ),
            self::invalid('proxy.router_node_invalid', 'proxy'),
            self::genuine(
                'proxy.router_route_mismatch',
                'proxy',
                'restore_proxy_router_route_mismatch',
            ),
            self::genuine(
                'proxy.router_route_missing',
                'proxy',
                'restore_proxy_router_route_missing',
            ),
            self::blocked('proxy.runtime_unreachable', 'proxy'),
            self::genuine(
                'proxy.s3.public_route_missing',
                'proxy',
                'restore_proxy_s3_public_route_missing',
            ),
            self::genuine(
                'proxy.s3.router_backend_invalid',
                'proxy',
                'restore_proxy_s3_router_backend_invalid',
            ),
            self::genuine(
                'proxy.s3.router_route_missing',
                'proxy',
                'restore_proxy_s3_router_route_missing',
            ),
            self::genuine(
                'proxy.s3.router_route_orphaned',
                'proxy',
                'restore_proxy_s3_router_route_orphaned',
            ),
            self::genuine(
                'proxy.tls_mismatch',
                'proxy',
                'restore_proxy_tls_mismatch',
            ),
            self::genuine(
                'proxy.tls_missing',
                'proxy',
                'restore_proxy_tls_missing',
            ),
            self::genuine(
