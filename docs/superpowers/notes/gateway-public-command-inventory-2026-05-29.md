...
- Invokable command rows covered: 136 total, including 127 non-internal rows and 9 internal `App\Console\Commands\Internal\*` rows kept explicit for the allowed `orbit:internal:*` category.
...
| `app:agent-ide` | `App\Console\Commands\AppAgentIdeCommand` | `App\Commands\App\AppAgentIdeCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/App/* |
...
| `app:new` | `App\Console\Commands\AppNewCommand` | `App\Commands\App\AppNewCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/App/* |
| `app:prune` | `App\Console\Commands\AppPruneCommand` | `App\Commands\App\AppPruneCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/App/* |
...
| `app:remove` | `App\Console\Commands\AppRemoveCommand` | `App\Commands\App\AppRemoveCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/App/* |
...
| `doctor` | `App\Console\Commands\DoctorCommand` | `App\Commands\Operation\DoctorCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Operation/* |
...
| `gateway:add` | `App\Console\Commands\GatewayAddCommand` | `App\Commands\Gateway\GatewayAddCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Gateway/* |
| `gateway:trust` | `App\Console\Commands\GatewayTrustCommand` | `App\Commands\Gateway\GatewayTrustCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Gateway/* |
| `node role:add` | `App\Console\Commands\NodeRoleAddCommand` | `App\Commands\Node\NodeRoleAddCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
| `node role:list` | `App\Console\Commands\NodeRoleListCommand` | `App\Commands\Node\NodeRoleListCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
| `node role:remove` | `App\Console\Commands\NodeRoleRemoveCommand` | `App\Commands\Node\NodeRoleRemoveCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
| `node:agent-ide` | `App\Console\Commands\NodeAgentIdeCommand` | `App\Commands\Node\NodeAgentIdeCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
| `node:grant` | `App\Console\Commands\NodeGrantCommand` | `App\Commands\Node\NodeGrantCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
...
| `node:permissions` | `App\Console\Commands\NodePermissionsCommand` | `App\Commands\Node\NodePermissionsCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
| `node:remove` | `App\Console\Commands\NodeRemoveCommand` | `App\Commands\Node\NodeRemoveCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
| `node:revoke` | `App\Console\Commands\NodeRevokeCommand` | `App\Commands\Node\NodeRevokeCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
...
| `node:update` | `App\Console\Commands\NodeUpdateCommand` | `App\Commands\Node\NodeUpdateCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Node/* |
...
| `update` | `App\Console\Commands\UpdateCommand` | `App\Commands\Operation\UpdateCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Operation/* |
| `update:all` | `App\Console\Commands\UpdateAllCommand` | `App\Commands\Operation\UpdateAllCommand` | none in required app call-site sweep | `delete` | #545 then #542 | apps/cli/tests/Feature/Commands/Operation/* |
...
- ORBIT-PRE-S3-03 (#545) records the app/node/local coverage pass for the #542
  command-removal family. Rows in that family now marked `delete` have CLI
  owner coverage for command signatures, local validation, JSON envelopes, human
  output, gateway request payloads, streams, and local config behavior. Rows
  that remain `internalize-extract-first` already have CLI owner coverage, but
  live gateway API/controller call sites must be extracted before deleting the
  gateway command class.
