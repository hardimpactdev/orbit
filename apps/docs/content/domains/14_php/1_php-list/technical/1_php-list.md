# Technical Contract: `orbit php:list [--instance=<app.instance>] [--workspace=<workspace>] [--node=<node>] [--live] [--json]`
...
- Resolves exactly one target context from an explicit dotted instance
  ...
  instance to stand in for an app.
...
owns PHP image capability drift. [`doctor --family=instance`](../../../5_app/instance-doctor.md)
